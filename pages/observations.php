...
<head>
    ...
    <link rel="stylesheet" href="/Sensli1/ProyectoFormativo/assets/css/observations.css">
        ...
        <main>
            ...
            <div id="containerObservations">
                ...
                <div id="rightContent">
                    ...
                    <div id="rightButton">
                        <button id="addObservationButton" onclick="window.location.href = '/Sensli1/ProyectoFormativo/pages/createObservation.php'">Añadir Observación</button>
                    </div>
                </div>
            </div>
        </main>
