			...
			<div class="flex justify-start items-start min-h-screen ml-[0px] mt-16">
				<div class="ficha-container bg-white p-6 shadow-lg rounded-lg w-full max-w-6xl">
					...
					<div class="acciones mt-6 flex justify-center flex-wrap gap-4">
						...
						<button id="btn-inactivar" class="btn rojo px-6 py-2 rounded-md text-white bg-red-500 hover:bg-red-600" onclick="window.location.href='/Sensli1/ProyectoFormativo/pages/tokens.php'">Inactivar</button>
						<button class="btn azul px-6 py-2 rounded-md text-white bg-blue-500 hover:bg-blue-600" onclick="window.location.href='/Sensli1/ProyectoFormativo/pages/tokens.php'">Generar Reporte</button>
						<button class="btn azul px-6 py-2 rounded-md text-white bg-blue-500 hover:bg-blue-600" onclick="window.location.href='/Sensli1/ProyectoFormativo/pages/tokens.php'">Editar</button>
						<button class="btn verde px-6 py-2 rounded-md text-white bg-green-500 hover:bg-green-600" onclick="window.location.href='/Sensli1/ProyectoFormativo/pages/createApprentice.php'">Agregar Aprendiz</button>
						<button class="btn azul px-6 py-2 rounded-md text-white bg-blue-500 hover:bg-blue-600" onclick="window.location.href='/Sensli1/ProyectoFormativo/pages/editJudgments.php'">Editar Juicios</button>
					</div>
				</div>
			</div>
		</main>
