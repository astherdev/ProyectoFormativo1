            ...
            <div id="infoAdmin">
                ...
                <div id="infoContent">
                    ...
                    <select type="select" id = "selectObservation">
                        ...
                        <option value = "Observation">Resultados de aprendizaje no entregados</option>
                        <option value = "Observation">Tercera Oportunidad de test perdida</option>
                    </select>
                    <div class = "formLabel">
