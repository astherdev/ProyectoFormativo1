...
<head>
    ...
    <link rel="stylesheet" href="/Sensli1/ProyectoFormativo/assets/css/viewApprentice.css">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <main>
            ...
            <div class="viewApprentice-buttons">
                <button onclick="window.location.href='../pages/editApprentice.php'">Editar</button>
